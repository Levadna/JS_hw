        ...
        for(let c = 0; c < bricksInRow; c++)
        {
            ...
            if(bricks[c][r].status !== 0)
            {
                ...
                else if(bricks[c][r].status === 5)
                {
                    ...
                    ctx.lineTo(brickX + brickWidth - 10, brickY + brickHeight);
                    ctx.lineTo(brickX + 10, brickY + brickHeight);
                    ctx.closePath();
                    ctx.fillStyle = "black";
                    ctx.fill();
                    continue;
...
function checkWin()
{
    for(let c = 0; c < brickColumnCount; c++)
    {
        for(let r = 0; r < brickRowCount; r++)
        {
            if(bricks[c][r].status > 0 && bricks[c][r].status !== 5)
            {
                return false;
            }
        }
...
function animate()
{
    ...
    for(let i = potions.length - 1; i >= 0; i--)
    {
        ...
        )
        {
            ...
            {
                alert("УПС!!! Чорне зілля вас знищило!")
                location.reload(); 
            }
            potions.splice(i, 1);
            continue;
